...
const weddingPartyData = [
  ...
  // Groom's Side
  {
    ...
    role: 'best_man',
    side: 'groom',
    bio: 'CeeJay\'s best friend since high school and his adventure buddy. Marcus is an outdoor guide who has taken CeeJay on countless hiking and skiing trips.',
  ...
  },
  {
    ...
    role: 'groomsman',
    side: 'groom',
    bio: 'CeeJay\'s older brother and role model. Daniel is a firefighter who taught CeeJay the importance of helping others.',
  ...
  },
  {
    ...
    role: 'groomsman',
    side: 'groom',
    bio: 'CeeJay\'s college roommate and fraternity brother. Ryan is a financial advisor who still challenges CeeJay to video game tournaments.',
  ...
  },
  {
    ...
    role: 'groomsman',
    side: 'groom',
    bio: 'CeeJay\'s coworker and climbing partner. Alex is an engineer who shares CeeJay\'s passion for both technology and the outdoors.',
  ...
  },
  {
    ...
    role: 'ring_bearer',
    side: 'groom',
    bio: 'CeeJay\'s nephew who loves dinosaurs, soccer, and being the center of attention at family gatherings.',
    relationship: 'Nephew',
