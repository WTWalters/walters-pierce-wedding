                ...
                <div className="text-center space-y-4 px-8" style={{ minWidth: '300px' }}>
                  ...
                  <div className="px-4">
                    <p className="text-sm text-gray-600 leading-relaxed" style={{ hyphens: 'none', wordBreak: 'normal', minWidth: '250px' }}>
                      Fast forward two and a half years and on June 8th, 2025, Connor popped the question! After six months of planning, scheming, and trying not to give away the surprise, the date was picked, the photoshoot was scheduled, and Connor's nerves were sky-high.
                    </p>
