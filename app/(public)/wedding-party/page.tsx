...
export default function WeddingPartyPage() {
  ...
  const officiant: WeddingPartyMember[] = [
    {
      ...
      role: 'Officiant',
      side: 'officiant',
      bio: "J. Murdock will be officiating Emme and Connor's wedding. He and Emme go way back to his Colorado days, where he had the privilege of serving as a youth pastor for churches in Denver and Boulder. These days, J. works as a chaplain in Northern California, helping people find hope and meaning in life's biggest moments. Outside of work, he is equally at home telling a good story or trying out new recipes in the kitchen. Emme and Connor are deeply honored to have J. preside over their special day and stand with them as they celebrate surrounded by family and friends.",
  ...
  const flowerGirlsAndRingBearers: WeddingPartyMember[] = [
    ...
    },
    {
      ...
      role: 'Flower Girl',
      side: 'kids',
      bio: "Reagan is another one of Emme's precious nieces who will be joining Sophia as a flower girl.",
    ...
    },
    {
      ...
      role: 'Ring Bearer',
      side: 'kids',
      bio: "Andrew is Emme's nephew and the first of nieces and nephews. Andrew has the important task of keeping track of Daniel and the ring.",
